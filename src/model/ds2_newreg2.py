...
class DeepSpeech2ModelReg2(nn.Module):
    def __init__(
        self, 
        n_feats, 
        n_tokens, 
        ...
        self.conv_layers = nn.Sequential(
            ...
            nn.BatchNorm2d(32),
            nn.ReLU(inplace=True),
            nn.Conv2d(32, 48, kernel_size=(21, 11), stride=(2, 1), padding=(10, 5)), # TESTING 48
            nn.BatchNorm2d(48), # TESTING 48
            nn.ReLU(inplace=True),
        )
    ...
    def compute_rnn_input_size(self):
        ...
        freq = math.floor((freq + 2 * 10 - 21) / 2 + 1)
        return freq * 48 # changes from 96
